...
<body>
  ...
  <div class="bg-dark p-4 shadow-gold" style="width: 360px;">
    ...
    <form method="POST" action="backend/login.php" class="needs-validation" novalidate>
      <div class="mb-3">
      ...
      <button type="submit" name="submit" class="btn btn-warning w-100 fw-bold">Se connecter</button>
    </form>
  </div>
